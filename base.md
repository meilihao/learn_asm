...
## 汇编语法
NASM 和 GAS 之间最大的差异之一是语法. GAS 使用 AT&T 语法，这是一种相当老的语法，由 GAS 和一些老式汇编器使用；NASM 使用 Intel 语法，大多数汇编器都支持它，包括 TASM 和 MASM.但GAS 的现代版本支持 .intel_syntax 指令，因此允许在 GAS 中使用 Intel 语法.
